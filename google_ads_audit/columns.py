...
CANONICAL_COLUMN_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "match_type": ("match type", "keyword match type", "マッチタイプ"),
    ...
    "competitor": ("domain", "display url domain", "competitor", "競合"),
    "change_date": ("change date", "date/time", "日時", "変更日時"),
    "change_type": ("change type", "変更タイプ"),
    "changed_by": ("user", "changed by", "変更ユーザー"),
    "change_detail": ("change", "changes", "details", "変更内容"),
    "conversion_action": ("conversion action", "コンバージョン アクション"),
    "impressions": ("impr.", "impressions", "表示回数"),
    "clicks": ("clicks", "クリック数"),
    "cost": ("cost", "cost (converted currency)", "費用", "コスト"),
    "ctr": ("ctr", "クリック率"),
    "avg_cpc": ("avg. cpc", "average cpc", "平均クリック単価"),
    "conversions": ("conversions", "conv.", "コンバージョン"),
    "conversion_rate": ("conv. rate", "conversion rate", "コンバージョン率"),
    "cost_per_conversion": ("cost / conv.", "cost per conversion", "コンバージョン単価"),
    "conversion_value": ("conversion value", "conv. value", "コンバージョン値"),
    "impression_share": ("search impr. share", "impr. share", "インプレッション シェア"),
